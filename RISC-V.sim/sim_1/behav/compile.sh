...
ExecStep xelab -m64 --debug typical --relax -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot single_cycle_riscv_behav --prj D:/gkris/RISC-V/RISC-V.sim/sim_1/behav/single_cycle_riscv.prj   xil_defaultlib.single_cycle_riscv   xil_defaultlib.glbl
